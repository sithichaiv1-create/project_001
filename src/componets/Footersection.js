    ...
    <footer className="bg-black text-gray-300 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h2 className="text-white text-xl font-bold mb-4">Sudtupung</h2>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-white transition-colors duration-200">หน้าแรก</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">สินค้าทั้งหมด</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">โปรโมชั่น</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">บทความ/รีวิว</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Sudtupung. All rights reserved.</p>
        </div>
